...
using WilliamBrander.FieldTest;

namespace FieldTest_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new FieldTestPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(FieldTestPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
